...
// Dur decodes a Go duration string such as "30s". Going through TextUnmarshaler also rejects a
// bare integer, which a numeric decode would read as nanoseconds. A json format tag is no way
